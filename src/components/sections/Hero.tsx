  ...
  return (
    ...
    <div className="flex min-h-[100svh] flex-col lg:min-h-0">
      <section className="relative flex w-full flex-1 flex-col overflow-hidden lg:h-[calc(883*var(--u))] lg:flex-none">
        ...
        <div
          aria-hidden
          className="absolute inset-0 -z-[30] bg-[url('/hero/backdrop-mobile.png')] bg-cover bg-[position:50%_33%] bg-no-repeat lg:bg-[url('/hero/backdrop.png')] lg:bg-[length:100%_auto] lg:bg-[position:50%_50%]"
        />
        ...
        <div
          aria-hidden
          className="absolute inset-0 -z-10 bg-[url('/hero/portrait-mobile.png')] bg-cover bg-[position:50%_33%] bg-no-repeat lg:bg-[url('/hero/portrait-v2.png')] lg:bg-[length:100%_auto] lg:bg-[position:50%_50%]"
        />
